  ...
  <div class="col-lg-10 mx-auto">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="{{ route('admin.customers.store') }}" method="POST" enctype="multipart/form-data" class="js-submit-loader">
          @csrf
          ...
          <div class="d-flex gap-2 justify-content-end mt-3">
            ...
            <button type="submit" name="action" value="save" class="btn btn-primary"><i class="fas fa-check me-1"></i> Save</button>
          </div>
        </form>
      </div>
    </div>
