...
<div class="row">
  <div class="col-lg-10 mx-auto">
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('admin.loan-types.store') }}" method="POST" enctype="multipart/form-data" class="js-submit-loader">
          @csrf
          ...
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <select name="currency_type" class="form-select @error('currency_type') is-invalid @enderror" required>
          ...
          <div class="text-end mt-4">
            <button type="reset" class="btn btn-secondary"><i class="fas fa-redo me-2"></i>Reset</button>
            <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Create Loan Type</button>
          </div>
        </form>
      </div>
    </div>
...
<div id="ltCreateLoader" class="app-loader" aria-hidden="true"><div class="loader-spinner" role="status" aria-label="Loading"></div></div>
@endsection

@push('scripts')
<script>
(function(){
  const loader=document.getElementById('ltCreateLoader');
