<nav class="navbar navbar-expand-lg navbar-dark sticky-top">
    <div class="container">
        ...
        <!-- Brand -->
        <a class="navbar-brand" href="{{ route('home') }}" aria-label="Global Advisor Solution Home">
            <div class="navbar-brand-container">
                <img src="{{ asset('images/logo.png') }}" alt="Global Advisor Solution Logo" width="260" height="156"
                    loading="eager">
                <div class="navbar-brand-text">
                    <span class="brand-name">Global</span>
                    <span class="brand-tagline">Advisor Solution</span>
                </div>
            </div>
        </a>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="servicesDropdown">
                        ...
                        <li>
                            <a class="dropdown-item text-danger fw-bold" href="{{ route('complaint.form') }}">
                                <i class="fas fa-exclamation-triangle"></i> Customer Complaint
                            </a>
                        </li>
                    </ul>
                </li>
