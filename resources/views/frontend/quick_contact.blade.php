            ...
            <div class="col-lg-8" data-aos="fade-up">
                <div class="card shadow-sm h-100">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('quick-contact.store') }}"
                              method="POST"
                              enctype="multipart/form-data"
                              class="js-submit-loader">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="consultation"
                                            class="form-select @error('consultation') is-invalid @enderror">
                                        <option value="">{{ __('messages.select') }}</option>
                                        @foreach (['Phone','Office','Online','ផ្ទាល់'] as $opt)
                                            <option value="{{ $opt }}"
                                                {{ old('consultation') == $opt ? 'selected' : '' }}>
                                                {{ $opt }}
                                            </option>
                                        @endforeach
                                    </select>
