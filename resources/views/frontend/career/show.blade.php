            ...
            <div class="text-white">
                <nav aria-label="breadcrumb" class="mb-3">
                    <ol class="breadcrumb text-white-50">
                        ...
                        <li class="breadcrumb-item active text-warning">{{ Str::limit($job->translation()?->title, 60) }}
                        </li>
                    </ol>
                </nav>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm mb-4" data-aos="fade-up">
                        <div class="card-body p-4 p-md-5">
                            <h3 class="card-title mb-3"><i
                                    class="fas fa-file-alt text-primary me-2"></i>{{ __('messages.job_description') }}</h3>
                    ...
                    <div class="card border-0 shadow-sm mb-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="card-body p-4 p-md-5">
                            <h3 class="card-title mb-3"><i
                                    class="fas fa-tasks text-primary me-2"></i>{{ __('messages.responsibilities') }}</h3>
                    ...
                    <div class="card border-0 shadow-sm mb-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="card-body p-4 p-md-5">
                            <h3 class="card-title mb-3"><i
                                    class="fas fa-check-circle text-primary me-2"></i>{{ __('messages.requirements') }}
                            </h3>
                    ...
                    @if ($job->translation()?->benefits)
                        <div class="card border-0 shadow-sm" data-aos="fade-up" data-aos-delay="300">
                            <div class="card-body p-4 p-md-5">
                                <h3 class="card-title mb-3"><i
                                        class="fas fa-gift text-primary me-2"></i>{{ __('messages.benefits') }}</h3>
                    ...
                    <div class="card border-0 shadow-sm sticky-top" style="top: 100px;" data-aos="fade-left">
                        <div class="card-body p-4">
                            <h4 class="card-title mb-4 d-flex align-items-center">
                                <i class="fas fa-paper-plane text-primary me-2"></i>{{ __('messages.job_apply_now') }}
                            </h4>
                            ...
                            <form action="{{ route('career.apply', $job->slug) }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="resume[]"
                                        class="form-control @error('resume') is-invalid @enderror @error('resume.*') is-invalid @enderror"
                                        accept=".jpg,.jpeg,.png" multiple required>
                                    <small class="text-muted">
                                        Up to 3 images: JPG, JPEG, PNG (Max: 5MB each)
                                    </small>
                                    @error('resume')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <ul class="list-unstyled text-muted small">
                                @if ($job->application_deadline)
                                    <li class="mb-2"><i class="far fa-calendar me-2 text-primary"></i>Deadline:
                                        {{ \Carbon\Carbon::parse($job->application_deadline)->format('M d, Y') }}</li>
                                @endif
                                <li class="mb-2"><i
                                        class="fas fa-map-marker-alt me-2 text-primary"></i>{{ $job->location }}</li>
                                <li class="mb-2"><i
                                        class="fas fa-briefcase me-2 text-primary"></i>{{ ucfirst($job->employment_type) }}
                                </li>
                            </ul>
                        </div>
                    </div>
