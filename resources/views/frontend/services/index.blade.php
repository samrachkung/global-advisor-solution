...
@section('meta_description', __('messages.our_services') . ' — Comprehensive loan solutions for all your financial
    needs.')
    ...
    @php
        ...
        foreach ($loanTypes as $loan) {
            $items[] = [
                ...
                'image' => !empty($loan->poster)
                    ? asset('uploads/services/' . $loan->poster)
...
@section('content')
    <section class="page-header py-5" style="background: linear-gradient(135deg,#1e3a8a,#2563eb)">
        <div class="container">
            ...
            <p class="text-white-50" data-aos="fade-up" data-aos-delay="100">Comprehensive loan solutions for all your
                financial needs</p>
        </div>
    </section>
